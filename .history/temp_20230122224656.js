  ...
  render() {
    return (
      <Animatable.View
        ...
        delay={this.props.imageIndex * 900}
...
const [detailViewVisible, setDetailViewVisibility]= useState
  ...
  const scrollToActiveIndex = (index) =>{
    ...
    // if(index * (IMAGE_SIZE + SPACING) - IMAGE_SIZE /2){
    ...
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      // horizontal
        ...
        onMomentumScrollEnd={(ev) => {
           scrollToActiveIndex(Math.floor(ev.nativeEvent.contentOffset.x/ screenWidth))
        }}
        renderItem={({ item }) => {
          return (
