...
const images = [
  ...
  { id: "2", source: "https://source.unsplash.com/random/200x200?sig=2" },
  { id: "3", source: "https://source.unsplash.com/random/200x200?sig=343" },
  {
    id: "4",
    source:
      "https://source.unsplash.com/random/300x200?sig=${Math.random()*40}",
    ...
    return (
      <View>
        ...
        <View style={{ marginTop: 50 }}>
          ...
          <Image
            source={{ uri: "https://source.unsplash.com/random/300" }}
            style={{ height: 100, width: "100%", resizeMode: "contain" }}
          />
        </View>
      </View>
